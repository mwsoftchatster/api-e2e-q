 ...
 * 
 */
module.exports.sendApiE2EQErrorEmail = function (error) {
  var mailOptions = {
      from: '"Chatster" <mwsoft01@mwsoft.nl>', // sender address
      to: 'n.karpovas@yahoo.com', // list of receivers
      subject: 'Chatster Api E2E Q Error', // Subject line
      text: `Chatster E2E Q Error`, // plain text body
 ...
 * 
 */
module.exports.sendNewApiE2EQIsUpEmail = function () {
  var mailOptions = {
      from: '"Chatster" <mwsoft01@mwsoft.nl>', // sender address
      to: 'n.karpovas@yahoo.com', // list of receivers
      subject: 'Chatster New Api E2E Q Server Is Up', // Subject line
      text: `Chatster New Api E2E Q Server Is Up`
  };
  // send mail with defined transport object
  transporter.sendMail(mailOptions, (error, info) => {
      if (error) {
